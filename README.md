...
> If we edited code as ASTs instead of text, style guides would be pointless b/c style is a text concern. Also, syntax would have the potential to become ephemeral; you could apply different syntaxes to your AST the same way you can apply different stylesheets to your DOM.
>
> -- Me on [Twitter](https://twitter.com/josh_cheek/status/1025522412614557703)

I started playing with that idea here, though it's not really complete yet.

There is a short recording of it [here](https://twitter.com/josh_cheek/status/1025867457200828418).
